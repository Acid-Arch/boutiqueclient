...
import { a as set_private_env, c as set_public_env, b as base, d as app_dir, e as public_env, f as assets, s as setCookieExports, o as override, r as reset } from './set-cookie-CLsaEPEn.js';
import { t as text_decoder, b as base64_decode, d as decode_pathname, a as decode_params, n as normalize_path, c as disable_search, v as validate_layout_server_exports, e as validate_layout_exports, f as validate_page_server_exports, g as validate_page_exports, h as text_encoder, r as resolve, m as make_trackable, i as get_relative_path, j as base64_encode } from './utils-Bg2Rux6K.js';
import { r as readable, w as writable } from './index2-BbWlCfnE.js';
import { parse as parse$1, serialize } from 'cookie';
import { S as render, T as set, U as LEGACY_PROPS, V as get, W as flushSync, d as define_property, X as mutable_source, Y as init_operations, Z as get_first_child, _ as COMMENT_NODE, $ as HYDRATION_START, a0 as get_next_sibling, a1 as HYDRATION_ERROR, a2 as HYDRATION_END, a3 as hydration_failed, a4 as clear_text_content, a5 as array_from, a6 as component_root, a7 as is_passive_event, a8 as create_text, a9 as branch, p as push, M as setContext, j as pop, aa as push$1, ab as component_context, c as active_effect, ac as pop$1 } from './index3-0vHBXF6s.js';
import { a as all_registered_events, r as root_event_handles, h as handle_event_propagation } from './events-D7LqLiIZ.js';
import 'clsx';
    ...
    app: ({ head, body, assets, nonce, env }) => '<!doctype html>\n<html lang="en" class="%sveltekit.theme%">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets + '/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		<meta name="description" content="Secure client portal for boutique services" />\n		<meta name="robots" content="noindex, nofollow" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover" class="bg-background text-foreground">\n		<div style="display: contents">' + body + '</div>\n		<!-- Security monitoring script -->\n		<script nonce="' + nonce + `">
			...
			window.addEventListener('error', function(event) {
				if (event.error && event.error.name === 'SecurityError') {
					...
					// Could send to error reporting endpoint
				}
			});
...
<html lang="en">
	...
	<body>
		<div class="error-container">
			...
			<div class="error-code">Error ID: %sveltekit.error.id%</div>
			<div class="actions">
		...
		<script>
			// Auto-reload after 30 seconds if it's a temporary error
			if (window.location.search.includes('temporary=true')) {
				setTimeout(() => {
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./hooks.server-CB6X72BE.js'));
  let reroute;
  let transport;
  return {
    handle,
...
//# sourceMappingURL=index-Bdw6HGPk.js.map
